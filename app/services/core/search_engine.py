    ...
    async def search(
        ...
        try:
            ...
            response = SearchResponse(
                ...
                total_pages=(len(final_results) + request.pagination.size - 1) // request.pagination.size,
                has_next_page=len(final_results) > request.pagination.offset + request.pagination.size,
