...
from .cache_provider import get_cache_service
from .postgres_provider import get_postgres_adapter
...
async def get_semantic_cache_manager() -> CacheManager:
    ...
    async with _cache_lock:
        ...
        redis_client = None
        cache_service = await get_cache_service()
        # Attempt to use redis client if available on cache adapter
