...
try:
    ...
    class ClientError(Exception):  # type: ignore
        pass
    class ClientResponseError(Exception):  # type: ignore
        pass
    class ClientTimeout(Exception):  # type: ignore
        pass
...
class DefaultErrorClassifier(IErrorClassifier, IHealthCheck):
    ...
    def _classify_by_exception_type(self, error: Exception) -> ErrorCategory:
        ...
        if isinstance(error, asyncio.CancelledError):
            # CancelledError is special - treat as unknown since it's not in ErrorCategory
